...
(cl:defmethod cl:initialize-instance :after ((m <segment_and_classify-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'segment_and_classify-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name classifier_srv_definitions-srv:<segment_and_classify-request> is deprecated: use classifier_srv_definitions-srv:segment_and_classify-request instead.")))
...
(cl:defmethod transform-val ((m <segment_and_classify-request>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<segment_and_classify-request>)))
  ...
  "classifier_srv_definitions/segment_and_classifyRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'segment_and_classify-request)))
  "Returns string type for a service object of type 'segment_and_classify-request"
  "classifier_srv_definitions/segment_and_classifyRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<segment_and_classify-request>)))
  ...
  "c733423904dd903f58b9a9f320c00a6d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'segment_and_classify-request)))
  "Returns md5sum for a message object of type 'segment_and_classify-request"
  "c733423904dd903f58b9a9f320c00a6d")
...
(cl:defmethod cl:initialize-instance :after ((m <segment_and_classify-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'segment_and_classify-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name classifier_srv_definitions-srv:<segment_and_classify-response> is deprecated: use classifier_srv_definitions-srv:segment_and_classify-response instead.")))

(cl:ensure-generic-function 'clusters_indices-val :lambda-list '(m))
(cl:defmethod clusters_indices-val ((m <segment_and_classify-response>))
...
(cl:defmethod class_results-val ((m <segment_and_classify-response>))
...
(cl:defmethod centroid-val ((m <segment_and_classify-response>))
...
(cl:defmethod bbox-val ((m <segment_and_classify-response>))
...
(cl:ensure-generic-function 'cloud-val :lambda-list '(m))
(cl:defmethod cloud-val ((m <segment_and_classify-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader classifier_srv_definitions-srv:cloud-val is deprecated.  Use classifier_srv_definitions-srv:cloud instead.")
  (cloud m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<segment_and_classify-response>)))
  ...
  "classifier_srv_definitions/segment_and_classifyResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'segment_and_classify-response)))
  "Returns string type for a service object of type 'segment_and_classify-response"
  "classifier_srv_definitions/segment_and_classifyResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'segment_and_classify)))
  ...
  "classifier_srv_definitions/segment_and_classify")