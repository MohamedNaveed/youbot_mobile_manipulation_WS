...
"""autogenerated by genpy from classifier_srv_definitions/classifyRequest.msg. Do not edit."""
import sys
...
class classifyRequest(genpy.Message):
  _md5sum = "7c87305be11dacad06ffe555e62f6ad3"
  _type = "classifier_srv_definitions/classifyRequest"
...
uint32 stride  # stride of given dimension"""
  __slots__ = ['cloud','clusters_indices']
  _slot_types = ['sensor_msgs/PointCloud2','std_msgs/Int32MultiArray[]']
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from classifier_srv_definitions/classifyResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class classifyResponse(genpy.Message):
  ...
  _type = "classifier_srv_definitions/classifyResponse"
  _has_header = False #flag to mark the presence of a Header object
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          (_x.size, _x.stride,) = _struct_2I.unpack(str[start:end])
          _v14.dim.append(val3)
        start = end
        end += 4
        (_v14.data_offset,) = _struct_I.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%si'%length
...
class classify(object):
  _type          = 'classifier_srv_definitions/classify'
  _md5sum = '6da3c30c72cafedd00b3379838f889d2'
